 ...
 */
#define SHORT_BUILD_VERSION "2.1.3-Pmc MRiscoC"
...
#else
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " Ender3V2-422-BLTUBL-IS-LA-MPC-PMcG, based on bugfix-2.1.x"
#endif
 ...
 */
#define MACHINE_NAME "PMcG Ender 3V2"
